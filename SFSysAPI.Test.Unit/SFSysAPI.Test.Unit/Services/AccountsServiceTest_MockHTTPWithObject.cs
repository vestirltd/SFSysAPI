...
{
    public class AccountsServiceTest_MockHTTPWithObject
    {
        ...
        public AccountsServiceTest_MockHTTPWithObject()
        {
        ...
        public async Task GetAccessToken_ShouldReturnAccessToken_WhenResponseIsSuccessful()
        {
            ...
            {
                Content = new StringContent(JsonSerializer.Serialize(new { access_token = "mock_access_token_value" }))
            };
